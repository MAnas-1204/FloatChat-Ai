  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--brand-cyan) / 0.35), 0 0 30px 0 hsl(var(--brand-cyan) / 0.35)" },
          "50%": { boxShadow: "0 0 0 6px hsl(var(--brand-cyan) / 0.0), 0 0 45px 6px hsl(var(--brand-cyan) / 0.55)" },
        },
        "ping-slow": {
